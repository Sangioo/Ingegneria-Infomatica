...
short compute(short x) {
    return -x;
}

int test(short* inp_1, unsigned* inp_2, int len, short* exp)
{
    tests += 1;
    short *out = malloc(len * sizeof(short));
