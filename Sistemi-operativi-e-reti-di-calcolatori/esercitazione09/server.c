...
char *url_decode(const char *src) {
    ...
    return decoded;
        ...
        /*************************************************************************
         * COMPLETARE
         * 7 Risposta: Creazione Messaggio HTTP
         *
         *************************************************************************/
...
void build_http_response(const char *file_name, 
    ...
    snprintf(header, BUFFER_SIZE,
        ...
        /*************************************************************************
         * Fine - 7 Risposta: Esistenza del file
         *************************************************************************/
    ...
    // char* file_name_full[strlen(file_name) + strlen(file_ext)];
    // file_name_full[0] = '\0';
    // strcat(file_name_full, get_file_case_insensitive(file_name));
    // strcat(file_name_full, ".");
    // strcpy(file_name_full, file_ext);
    ...
    if (bytes_received > 0) {
         ...
         *************************************************************************/
            ...
            while (bytes_sent < response_len) {
                ret = send(client_fd, response, response_len, 0);
                if (ret == 0) break;
                if (ret < 0) {
...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        if (ret) perror("Could not create the thread");
        /*************************************************************************
